        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="<%= getServletContext().getContextPath()%>/Admin/Customer""><b>List of customer</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="<%= getServletContext().getContextPath()%>/Admin/Customer/Add" title="Thêm"><i class="fas fa-plus"></i>
                                        Add New Customer</a>
                                </div>                           
                            </div>
                            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>                             
                                    <%
                                        ...
                                        ResultSet rs = dao.ListAllAccount();
                                        while (rs.next()) {
                                    %>   
                                    <tr>                                        
