<%-- 
    Document   : form-add-san-pham-file
    Created on : Mar 16, 2023, 5:43:19 PM
    Author     : User
--%>
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="<%= getServletContext().getContextPath()%>/Admin/Product/AddFile">Add list product</a></li>
                </ul>
            </div>  
              <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Add List Product</h3>
                        <div class="tile-body">
                        ...
                        <button class="btn btn-save" type="Submit" value="addfile" name="addFile">Add</button>
